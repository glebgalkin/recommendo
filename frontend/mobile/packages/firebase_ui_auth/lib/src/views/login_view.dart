...
class _LoginViewState extends State<LoginView> {
  ...
  List<Widget> _buildHeader(BuildContext context) {
    ...
    return [
      AnimatedCrossFade(
        firstChild: Title(text: l.signInText),
        secondChild: Title(text: l.registerText),
        crossFadeState: _action == AuthAction.signIn
